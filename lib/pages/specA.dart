    ...
    return Scaffold(
      ...
      body: Column(
        children: [
                ...
                children: [
                  ...
                  Container(
                    margin: EdgeInsets.symmetric(
                        vertical: 16.0), // Space around the image
                    height: 450.0, // Adjust height as needed
                    width: double.infinity, // Full width
                    decoration: BoxDecoration(
                      color:
                          Colors.grey[300], // Placeholder color for the image
                      borderRadius:
                          BorderRadius.circular(8.0), // Rounded corners
                    ),
                    child: Center(
                        child: Image.asset(memberInfo.image)), // Display image
                  ),
                  // Gray box with text
                  Container(
                    padding: EdgeInsets.all(16.0),
                    margin: EdgeInsets.symmetric(
                        horizontal: 16.0), // Space on sides
                    decoration: BoxDecoration(
                      ...
                      children: [
                        Row(
                          mainAxisAlignment: MainAxisAlignment
                              .spaceBetween, // Align name and MBTI
                          children: [
                            Text(
          ...
          Padding(
            padding:
                const EdgeInsets.only(bottom: 40.0), // Adjust spacing as needed
